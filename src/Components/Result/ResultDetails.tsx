...
function ResultDetails() {
  ...
  return (
    <div className='mt-6 result bg-blue-50 xs:w-[375px] sm:w-[640px] md:w-[700px] h-[200px] rounded-md border-2 border-blue-100'>
              <div className="top border-b-2 flex justify-between">

                <div className='topright xs: xs:w-[375px] sm:w-[640px] md:w-[700px] h-[100px] flex flex-col justify-between p-2'>
                ...
                <div className='toprleft  xs:w-[375px] sm:w-[640px] md:w-[700px] h-[100px] flex flex-col justify-between border-r-2 p-2'>
                  <div className=' flex  gap-x-8'>
              ...
              <div className='bottomright  xs:w-[375px] sm:w-[640px] md:w-[700px] h-[100px] flex flex-col justify-between p-2'>
                  <div className=' flex  gap-x-8'>
                ...
                <div className='bottomleft  xs:w-[375px] sm:w-[640px] md:w-[700px] h-[100px] flex flex-col justify-between border-r-2 p-2'>
                  <div className=' flex  gap-x-8'>
